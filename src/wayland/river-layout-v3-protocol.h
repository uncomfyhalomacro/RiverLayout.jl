...
{
	wl_proxy_marshal((struct wl_proxy *) river_layout_manager_v3,
			 RIVER_LAYOUT_MANAGER_V3_DESTROY);

	wl_proxy_destroy((struct wl_proxy *) river_layout_manager_v3);
}
...
river_layout_manager_v3_get_layout(struct river_layout_manager_v3 *river_layout_manager_v3, struct wl_output *output, const char *namespace)
{
	...
	id = wl_proxy_marshal_constructor((struct wl_proxy *) river_layout_manager_v3,
			 RIVER_LAYOUT_MANAGER_V3_GET_LAYOUT, &river_layout_v3_interface, NULL, output, namespace);
...
{
	wl_proxy_marshal((struct wl_proxy *) river_layout_v3,
			 RIVER_LAYOUT_V3_DESTROY);

	wl_proxy_destroy((struct wl_proxy *) river_layout_v3);
}
...
{
	wl_proxy_marshal((struct wl_proxy *) river_layout_v3,
			 RIVER_LAYOUT_V3_PUSH_VIEW_DIMENSIONS, x, y, width, height, serial);
}
...
{
	wl_proxy_marshal((struct wl_proxy *) river_layout_v3,
			 RIVER_LAYOUT_V3_COMMIT, layout_name, serial);
}
